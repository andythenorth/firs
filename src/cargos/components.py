...
cargo = Cargo(
    id="components",
    type_name="string(STR_CARGO_COMPONENTS_NAME)",
    unit_name="string(STR_CARGO_COMPONENTS_NAME)",
    type_abbreviation="string(STR_CARGO_COMPONENTS_CID)",
    ...
    items_of_cargo="string(STR_CARGO_COMPONENTS_CARGO_UNIT)",
