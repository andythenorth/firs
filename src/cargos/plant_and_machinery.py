...
cargo = Cargo(
    ...
    type_name="string(STR_CARGO_PLANT_AND_MACHINERY_NAME)",
    unit_name="string(STR_CARGO_PLANT_AND_MACHINERY_NAME)",
    type_abbreviation="string(STR_CARGO_PLANT_AND_MACHINERY_CID)",
    ...
    items_of_cargo="string(STR_CARGO_PLANT_AND_MACHINERY_CARGO_UNIT)",
