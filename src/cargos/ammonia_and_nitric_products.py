...
cargo = Cargo(
    ...
    type_name="string(STR_CARGO_AMMONIA_AND_NITRIC_PRODUCTS_NAME)",
    unit_name="string(STR_CARGO_AMMONIA_AND_NITRIC_PRODUCTS_NAME)",
    type_abbreviation="string(STR_CARGO_AMMONIA_AND_NITRIC_PRODUCTS_CID)",
    ...
    items_of_cargo="string(STR_CARGO_AMMONIA_AND_NITRIC_PRODUCTS_CARGO_UNIT)",
