...
cargo = Cargo(
    id="frozen_food",
    type_name="string(STR_CARGO_FROZEN_FOOD_NAME)",  # CABBAGE
    unit_name="string(STR_CARGO_FROZEN_FOOD_NAME)",  # CABBAGE
    ...
    items_of_cargo="string(STR_CARGO_FROZEN_FOOD_CARGO_UNIT)",  # CABBAGE
