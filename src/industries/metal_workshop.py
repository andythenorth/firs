...
industry.economy_variations['STEELTOWN'].processed_cargos_and_output_ratios = [('STEL', 6), ('NICK', 2), ('RFPR', 2)]
industry.economy_variations['STEELTOWN'].prod_cargo_types = ['VPTS', 'MNSP']
