...
industry.add_industry_layout(
    ...
    layout = [(0, 0, 'oil_refinery_tile_1', 'oil_refinery_spritelayout_2'),
              ...
              (3, 1, 'oil_refinery_tile_1', 'oil_refinery_spritelayout_3'),
              (3, 2, 'oil_refinery_tile_1', 'oil_refinery_spritelayout_1'),
              (3, 3, 'oil_refinery_tile_1', 'oil_refinery_spritelayout_1'),
              (3, 4, 'oil_refinery_tile_1', 'oil_refinery_spritelayout_1'),
              (3, 5, 'oil_refinery_tile_1', 'oil_refinery_spritelayout_1'),
              (4, 1, 'oil_refinery_tile_1', 'oil_refinery_spritelayout_5'),
              (4, 2, 'oil_refinery_tile_1', 'oil_refinery_spritelayout_1'),
              (4, 3, 'oil_refinery_tile_1', 'oil_refinery_spritelayout_1'),
              (4, 4, 'oil_refinery_tile_1', 'oil_refinery_spritelayout_1'),
              (4, 5, 'oil_refinery_tile_1', 'oil_refinery_spritelayout_1'),
    ]
)
industry.add_industry_layout(
