...
industry = Industry(id='bulk_terminal',
                    ...
                    nearby_station_name='string(STR_STATION, string(STR_TOWN), string(STR_IND_BULK_TERMINAL))',
...
industry.add_industry_layout(
    ...
    layout = [(0, 0, 'bulk_terminal_tile_2', 'bulk_terminal_slope_switch_2'),
              ...
              (1, 0, 'bulk_terminal_tile_1', 'bulk_terminal_spritelayout_24'),
              (1, 2, 'bulk_terminal_tile_1', 'bulk_terminal_spritelayout_2'),
              (2, 1, 'bulk_terminal_tile_1', 'bulk_terminal_spritelayout_26'),
              (2, 2, 'bulk_terminal_tile_1', 'bulk_terminal_spritelayout_28'),
              (2, 3, 'bulk_terminal_tile_1', 'bulk_terminal_spritelayout_22'),
...
industry.add_industry_layout(
    ...
    layout = [(0, 0, 'bulk_terminal_tile_2', 'bulk_terminal_slope_switch_1'),
              ...
              (1, 2, '255', 'bulk_terminal_spritelayout_null'),
              (2, 0, 'bulk_terminal_tile_1', 'bulk_terminal_spritelayout_3'),
              (2, 1, 'bulk_terminal_tile_1', 'bulk_terminal_spritelayout_29'),
              (2, 2, 'bulk_terminal_tile_1', 'bulk_terminal_spritelayout_13'),
              (2, 3, '255', 'bulk_terminal_spritelayout_null'),
              (3, 0, 'bulk_terminal_tile_1', 'bulk_terminal_spritelayout_30'),
              (3, 1, 'bulk_terminal_tile_1', 'bulk_terminal_spritelayout_13'),
              (3, 2, 'bulk_terminal_tile_1', 'bulk_terminal_spritelayout_13'),
              (3, 3, '255', 'bulk_terminal_spritelayout_null'),
              (4, 255, '255', 'bulk_terminal_spritelayout_null'),
              (4, 0, 'bulk_terminal_tile_1', 'bulk_terminal_spritelayout_24'),
              (4, 1, 'bulk_terminal_tile_1', 'bulk_terminal_spritelayout_24'),
              (4, 2, 'bulk_terminal_tile_1', 'bulk_terminal_spritelayout_24'),
