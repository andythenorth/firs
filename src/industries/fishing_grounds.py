...
industry = IndustryPrimaryNoSupplies(id='fishing_grounds',
                    ...
                    location_checks=dict(require_cluster=['fishing_grounds', [20, 84, 1, 5]],
                                                           coast_distance=True),
...
industry.add_industry_layout(
    ...
    layout = [(0, 0, '255', 'fishing_grounds_spritelayout_null'),
              (0, 1, '24', 'fishing_grounds_spritelayout_null'),
              (0, 2, '24', 'fishing_grounds_spritelayout_null'),
              (0, 3, '24', 'fishing_grounds_spritelayout_null'),
