...
industry = IndustrySecondary(id='polyethylene_plant',
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'polyethylene_plant_tile_1', 'polyethylene_plant_spritelayout_2'),
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'polyethylene_plant_tile_1', 'polyethylene_plant_spritelayout_8'),
