...
industry = IndustrySecondary(id='foundry',
                    ...
                    prod_multiplier='[0, 0]',
                    map_colour='123',
                    location_checks=dict(incompatible={'foundry': 56}),
...
spriteset_ground = industry.add_spriteset(
    id = 'foundry_spriteset_ground',
    type = 'cobble',
)
spriteset_ground_overlay = industry.add_spriteset(
    id = 'foundry_spriteset_ground_overlay',
    type = 'empty'
)
spriteset_1 = industry.add_spriteset(
    id = 'foundry_spriteset_1',
    sprites = [(10, 60, 64, 70, -31, -39)],
)
spriteset_2 = industry.add_spriteset(
    id = 'foundry_spriteset_2',
    sprites = [(80, 60, 64, 70, -31, -39)],
)
spriteset_3 = industry.add_spriteset(
    id = 'foundry_spriteset_3',
    sprites = [(150, 60, 64, 51, -31, -20)],
)
spriteset_4 = industry.add_spriteset(
    id = 'foundry_spriteset_4',
    sprites = [(220, 60, 64, 51, -31, -20)],
)
spriteset_5 = industry.add_spriteset(
    id = 'foundry_spriteset_5',
    sprites = [(290, 60, 64, 51, -31, -20)],
)
spriteset_6 = industry.add_spriteset(
    id = 'foundry_spriteset_6',
    sprites = [(360, 60, 64, 31, -31, 0)],
)
spriteset_7 = industry.add_spriteset(
    id = 'foundry_spriteset_7',
