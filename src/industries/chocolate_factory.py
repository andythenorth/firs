...
industry = IndustrySecondary(
    ...
    location_checks=dict(chocolate_factory_layouts_by_date=True),
    name="string(STR_IND_CHOCOLATE_FACTORY)",
...
industry.add_spritelayout(
    id="chocolate_factory_spritelayout_brickbakery_1",
    tile="chocolate_factory_tile_1",
...
industry.add_spritelayout(
    id="chocolate_factory_spritelayout_brickbakery_2",
    tile="chocolate_factory_tile_1",
    ground_sprite=spriteset_ground_bakery,
...
industry.add_spritelayout(
    id="chocolate_factory_spritelayout_brickbakery_3",
    tile="chocolate_factory_tile_1",
    ground_sprite=spriteset_ground_bakery,
...
industry.add_spritelayout(
    id="chocolate_factory_spritelayout_brickbakery_4",
    tile="chocolate_factory_tile_1",
    ground_sprite=spriteset_ground_bakery,
...
industry.add_spritelayout(
    id="chocolate_factory_spritelayout_windmill_anim",
    tile="chocolate_factory_tile_1",
    ground_sprite=None,
...
industry.add_spritelayout(
    id="chocolate_factory_spritelayout_windmill_granary",
    tile="chocolate_factory_tile_1",
    ground_sprite=None,
...
industry.add_spritelayout(
    id="chocolate_factory_spritelayout_windmill_shed",
    tile="chocolate_factory_tile_1",
    ground_sprite=None,
...
industry.add_spritelayout(
    id="chocolate_factory_spritelayout_windmill_greeble",
    tile="chocolate_factory_tile_1",
    ground_sprite=None,
...
industry.add_industry_layout(
    id="chocolate_factory_industry_layout_1",
    layout=[
        (0, 0, "chocolate_factory_spritelayout_brickbakery_3"),
        (0, 1, "chocolate_factory_spritelayout_brickbakery_4"),
        (1, 0, "chocolate_factory_spritelayout_brickbakery_1"),
        (1, 1, "chocolate_factory_spritelayout_brickbakery_2"),
    ],
)
industry.add_industry_layout(
    id="chocolate_factory_industry_layout_2",
    layout=[
        (0, 0, "chocolate_factory_spritelayout_brickbakery_3"),
        (0, 1, "chocolate_factory_spritelayout_brickbakery_4"),
        (1, 0, "chocolate_factory_spritelayout_brickbakery_3"),
        (1, 1, "chocolate_factory_spritelayout_brickbakery_4"),
        (2, 0, "chocolate_factory_spritelayout_brickbakery_1"),
        (2, 1, "chocolate_factory_spritelayout_brickbakery_2"),
    ],
)
industry.add_industry_layout(
    id="chocolate_factory_industry_layout_3",
    layout=[
        (0, 0, "chocolate_factory_spritelayout_brickbakery_3"),
        (0, 1, "chocolate_factory_spritelayout_brickbakery_4"),
        (0, 2, "chocolate_factory_spritelayout_brickbakery_3"),
        (0, 3, "chocolate_factory_spritelayout_brickbakery_4"),
        (1, 0, "chocolate_factory_spritelayout_brickbakery_1"),
        (1, 1, "chocolate_factory_spritelayout_brickbakery_2"),
        (1, 2, "chocolate_factory_spritelayout_brickbakery_1"),
        (1, 3, "chocolate_factory_spritelayout_brickbakery_2"),
    ],
)
industry.add_industry_layout(
    id="chocolate_factory_industry_layout_4",
    layout=[
        (0, 0, "chocolate_factory_spritelayout_windmill_shed"),
        (0, 1, "chocolate_factory_spritelayout_windmill_granary"),
        (1, 0, "chocolate_factory_spritelayout_windmill_anim"),
        (1, 1, "chocolate_factory_spritelayout_windmill_greeble"),
    ],
)
industry.add_industry_layout(
    id="chocolate_factory_industry_layout_5",
    layout=[
        (0, 0, "chocolate_factory_spritelayout_windmill_shed"),
        (0, 1, "chocolate_factory_spritelayout_windmill_anim"),
        (1, 0, "chocolate_factory_spritelayout_windmill_granary"),
        (1, 1, "chocolate_factory_spritelayout_windmill_greeble"),
    ],
)
industry.add_industry_layout(
    id="chocolate_factory_industry_layout_6",
    layout=[
        (0, 0, "chocolate_factory_spritelayout_windmill_granary"),
        (0, 1, "chocolate_factory_spritelayout_windmill_greeble"),
        (1, 0, "chocolate_factory_spritelayout_windmill_anim"),
        (1, 1, "chocolate_factory_spritelayout_windmill_shed"),
    ],
)
