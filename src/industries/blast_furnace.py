...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'blast_furnace_tile_1', 'blast_furnace_spritelayout_blast_furnace_1'),
            (0, 1, 'blast_furnace_tile_1', 'blast_furnace_spritelayout_blast_furnace_2'),
            (0, 2, 'blast_furnace_tile_1', 'blast_furnace_spritelayout_small_tanks'),
            (0, 3, 'blast_furnace_tile_1', 'blast_furnace_spritelayout_brick_building'),
            ...
            (1, 2, 'blast_furnace_tile_1', 'blast_furnace_spritelayout_small_shed'),
            (1, 3, 'blast_furnace_tile_1', 'blast_furnace_spritelayout_empty'),
            ...
            (2, 2, 'blast_furnace_tile_1', 'blast_furnace_spritelayout_greeble'),
            (2, 3, 'blast_furnace_tile_1', 'blast_furnace_spritelayout_empty'),
            (3, 0, 'blast_furnace_tile_1', 'blast_furnace_spritelayout_empty'),
            (3, 1, 'blast_furnace_tile_2', 'blast_furnace_spritelayout_large_shed_rear_part'),
            (3, 2, 'blast_furnace_tile_1', 'blast_furnace_spritelayout_small_shed'),
            (3, 3, 'blast_furnace_tile_1', 'blast_furnace_spritelayout_small_shed'),
            (4, 0, 'blast_furnace_tile_2', 'blast_furnace_spritelayout_casting_shed'),
            (4, 1, 'blast_furnace_tile_2', 'blast_furnace_spritelayout_large_shed_front_part'),
            (4, 2, 'blast_furnace_tile_1', 'blast_furnace_spritelayout_ladle_transporter'),
            (4, 3, 'blast_furnace_tile_1', 'blast_furnace_spritelayout_greeble'),
            ]
)
industry.add_industry_layout(
