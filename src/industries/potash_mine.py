...
industry = IndustryPrimaryExtractive(id='potash_mine',
                    ...
                    map_colour='16',
                    location_checks=IndustryLocationChecks(require_cluster=['potash_mine', [20, 70, 1, 3]],
                                                           incompatible={'fertiliser_plant': 16}),
...
spriteset_headgear_animated = industry.add_spriteset(
    id = 'potash_mine_spriteset_headgear_animated',
...
spriteset_exit_trestle_animated = industry.add_spriteset(
    id = 'potash_mine_spriteset_exit_trestle_animated',
