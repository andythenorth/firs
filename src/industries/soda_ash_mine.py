...
industry.add_multi_tile_object(
    ...
    view_layout=[
        ...
        (1, 0, "soda_ash_mine_spritelayout_crusher_middle_part"),
...
industry.add_industry_layout(
    ...
    layout=[
        ...
        (4, 0, "soda_ash_mine_spritelayout_crusher_middle_part"),
        (4, 1, "soda_ash_mine_spritelayout_crusher_middle_part"),
...
industry.add_industry_layout(
    ...
    layout=[
        ...
        (1, 2, "soda_ash_mine_spritelayout_crusher_middle_part"),
        (1, 3, "soda_ash_mine_spritelayout_crusher_middle_part"),
