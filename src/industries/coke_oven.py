...
industry.add_industry_layout(
    ...
    layout = [(0, 0, 'coke_oven_tile_1', 'coke_oven_spritelayout_2'),
              ...
              (0, 2, 'coke_oven_tile_1', 'coke_oven_spritelayout_6'),
              (1, 0, 'coke_oven_tile_1', 'coke_oven_spritelayout_4'),
              (1, 1, 'coke_oven_tile_1', 'coke_oven_spritelayout_5'),
              (1, 2, 'coke_oven_tile_1', 'coke_oven_spritelayout_3'),
    ]
)
industry.add_industry_layout(
    ...
    layout = [(0, 0, 'coke_oven_tile_1', 'coke_oven_spritelayout_2'),
              ...
              (2, 1, 'coke_oven_tile_1', 'coke_oven_spritelayout_3'),
    ]
)
industry.add_industry_layout(
    ...
    layout = [(0, 0, 'coke_oven_tile_1', 'coke_oven_spritelayout_2'),
              (0, 1, 'coke_oven_tile_1', 'coke_oven_spritelayout_1'),
              (0, 2, 'coke_oven_tile_1', 'coke_oven_spritelayout_6'),
              (0, 3, 'coke_oven_tile_1', 'coke_oven_spritelayout_6'),
              (1, 0, 'coke_oven_tile_1', 'coke_oven_spritelayout_4'),
              (1, 1, 'coke_oven_tile_1', 'coke_oven_spritelayout_5'),
              (1, 2, 'coke_oven_tile_1', 'coke_oven_spritelayout_3'),
