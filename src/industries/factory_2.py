...
industry = IndustrySecondary(id='factory_2',
                             accept_cargos_with_input_ratios=[('COPR', 2), ('STEL', 2), ('STWR', 2), ('PLAS', 2)],
...
industry.add_tile(id='factory_2_tile_1',
                  animation_length=47,
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'factory_2_tile_1', 'factory_2_spritelayout_3'),
...
industry.add_industry_layout(
    ...
    layout=[(0, 2, 'factory_2_tile_1', 'factory_2_spritelayout_3'),
