...
industry.economy_variations['BASIC_ARCTIC'].accept_cargo_types = ['PAPR', 'NICK', 'BOOM']
industry.economy_variations['BASIC_ARCTIC'].prod_cargo_types = ['MNSP', 'GOOD']
industry.economy_variations['BASIC_ARCTIC'].prod_multiplier = '[7]'
