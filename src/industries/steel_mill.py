...
industry = IndustrySecondary(id='steel_mill',
                             accept_cargos_with_input_ratios=[('IRON', 5), ('QLME', 1), ('ACID', 1), ('O2__', 1)],
                             combined_cargos_boost_prod=True,
                             prod_cargo_types_with_output_ratios=[('STSH', 3), ('STSE', 3), ('STWR', 2)],
                             prob_in_game='3',
                             prob_map_gen='5',
                             map_colour='160',
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'steel_mill_tile_1', 'steel_mill_spritelayout_3'),
...
industry.add_industry_layout(
    ...
    layout=[(0, 2, 'steel_mill_tile_1', 'steel_mill_spritelayout_3'),
