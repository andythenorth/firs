...
industry.add_industry_jetty_layout(
    ...
    layout=[
        (0, 0, "wharf_spritelayout_coast_warehouse"),
        (0, 1, "wharf_spritelayout_jetty_empty"),
        (0, 2, "wharf_spritelayout_crane_rails_nw_se"),
        (0, 3, "wharf_spritelayout_crane_nw_se"),
        (0, 4, "wharf_spritelayout_crane_rails_nw_se"),
        (0, 5, "spritelayout_null_water"),
        (1, 0, "wharf_spritelayout_coast_warehouse"),
        (1, 1, "wharf_spritelayout_crane_nw_se"),
        (1, 2, "wharf_spritelayout_water_barge_nw_se"),
        (1, 3, "wharf_spritelayout_water_empty"),
        (1, 4, "wharf_spritelayout_water_barge_nw_se"),
        (1, 5, "spritelayout_null_water"),
    ],
)
