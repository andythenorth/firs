...
industry = IndustrySecondary(id='aluminium_plant',
                    ...
                    min_cargo_distr='5',
                    spec_flags='0',
                    location_checks=IndustryLocationChecks(incompatible={'aluminium_plant': 56,
                                                                         'bulk_terminal': 16}),
...
industry.economy_variations['STEELTOWN'].processed_cargos_and_output_ratios = [('AORE', 2), ('QLME', 2), ('SCMT', 4)]
