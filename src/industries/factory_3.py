...
industry = IndustrySecondary(id='factory_3',
                             accept_cargos_with_input_ratios=[('GLAS', 2), ('PLAS', 2), ('ALUM', 2), ('TINP', 2)],
...
industry.add_tile(id='factory_3_tile_1',
                  animation_length=47,
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'factory_3_tile_1', 'factory_3_spritelayout_3'),
...
industry.add_industry_layout(
    ...
    layout=[(0, 2, 'factory_3_tile_1', 'factory_3_spritelayout_3'),
