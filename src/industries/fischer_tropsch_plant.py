...
industry = IndustrySecondary(id='fischer_tropsch_plant',
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'fischer_tropsch_plant_tile_1', 'fischer_tropsch_plant_spritelayout_1'),
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'fischer_tropsch_plant_tile_1', 'fischer_tropsch_plant_spritelayout_2'),
