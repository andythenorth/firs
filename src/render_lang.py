...
templates = PageTemplateLoader(os.path.join(currentdir, "src", "grf", "templates"))
...
def main():
    ...
    for file_name in os.listdir(os.path.join("src", "grf", "lang")):
