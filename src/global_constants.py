...
industry_numeric_ids = dict(coal_mine = 0,
                            ...
                            coffee_estate = 50,
                            bulk_terminal = 51,
                            ####UNUSED?####trading_post = 52,
                            ##IAHC##rubber_plantation = 53,
                            limestone_mine = 54,
                            ##IAHC##diamond_mine = 55,
                            food_processor = 56,
                            ###BLTC###hardware_store = 57,
                            hotel = 58,
                            ###BLTC###food_market = 59,
                            ###BLTC###petrol_pump = 60,
                            general_store = 61,
                            ...
                            pyrite_smelter = 72,
                            phosphate_mine = 73,
                            ####UNUSED?####liquids_terminal = 74,
                            ##IAHC##manganese_mine = 75,
                            ####UNUSED?####potash_mine = 76,
