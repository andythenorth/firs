...
economy = Economy(
    ...
    cargoflow_graph_tuning={
        ...
        "wormhole_industries": ["wharf", "bulk_terminal", "hardware_factory", "appliance_factory"],
        ...
        "ranking_subgraphs": [
            ...
            ("sink", ["food", "farm", "cranes_and_hoists", "hardware", "goods", "vehicles", "pipework", "assembly_plant", "machine_shop", "pipework_fabricator", "crane_and_hoist_factory"]),
        ],
        "clusters": [
            {
